            ...
            <div className={`flex items-start space-x-4 p-4 rounded-lg border-2 transition-all hover:shadow-md ${
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center space-x-2">
                  <button className="flex items-center space-x-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs hover:bg-blue-200 transition-colors">
                    <FileText className="h-3 w-3" />
                    <span>Historial</span>
                  </button>
                  <button className="flex items-center space-x-1 px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs hover:bg-green-200 transition-colors">
                    <Phone className="h-3 w-3" />
                    <span>Llamar</span>
                  </button>
                  {appointment.status === 'siguiente' && (
                    <button className="px-3 py-1 bg-yellow-500 text-white rounded-full text-xs hover:bg-yellow-600 transition-colors">
                      Iniciar consulta
                    </button>
                  )}
                </div>
