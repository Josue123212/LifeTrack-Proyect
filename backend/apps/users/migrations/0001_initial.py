    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Cliente'), ('admin', 'Administrador'), ('superadmin', 'Super Administrador')], default='client', help_text='Rol del usuario en el sistema', max_length=20, verbose_name='Rol')),
